...
var settings: [SwiftSetting] {
    [
        ...
        /// A public import of a C++ module is not seen as used by any public declaration, even
        /// when the module's types are in the public API. An internal import instead makes the
        /// whole API invisible to clients.
        .treatWarning("UnusedImportAccess", as: .warning),
    ]
}
